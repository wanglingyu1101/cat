                        ...
                        <div className="white-bg topbar-bg ">
                            ...
                            <div className="switch-hot" data-active=".n-hot">
                                <div className="hot-item active" data-tab=".n-hot">
                                    <NavLink style={{color:"skyblue"}} activeStyle={{color:"red"}} to={'/movie'} exact>正在热映</NavLink>
                                </div>
                                <div className="hot-item " data-tab=".f-hot">
                                    <NavLink style={{color:"skyblue"}} activeStyle={{color:"red"}} to={'/movie/coming'}>即将上映</NavLink>
                                </div>
                            </div>
                            <Link to={'/search'}><div className="search-entry search-icon" data-type="movie"> </div></Link>
                        </div>
                    </section>
                </div>
