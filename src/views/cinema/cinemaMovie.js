...
class CinemaMovie extends React.Component {
            ...
            <div>
                ...
                <div className="movie-detail">
                    ...
                    <div className="detail box-flex">
                        ...
                        <div className="content flex">
                            ...
                            {
                                this.props.detailMovie.comScorePersona === true ?
                                    <div className="score line-ellipsis">{this.props.detailMovie.sc}<span
                                        className="snum">({this.$tools.people(this.props.detailMovie.snum)}万人评)</span>
                                    </div> : <div className="score line-ellipsis"><span
                                        style={{fontSize: '14px'}}>{this.props.detailMovie.wish}人想看</span></div>
                            }
                            <div className="type line-ellipsis">
                                <span>{this.props.detailMovie.cat}</span>
                                <div className="type-group">
                                    {
                                        this.props.detailMovie.version === "" ? null :
                                            <img alt="" style={{width: '42px'}} className="sd-imax"
                            ...
                            <div
                                className="src line-ellipsis">{this.props.detailMovie.src}/{this.props.detailMovie.dur}分钟
                            </div>
                    ...
                    <ul id="timeline" className="mb-line-b" ref={'showDay'}>
                        {
                            this.props.deMovieList.showDays ? this.props.deMovieList.showDays.dates.map((v, i) => (
                                <li className={i === 0 ? 'showDay chosen' : 'showDay'} key={i} onClick={(e) => {
                ...
                <div className="nav-wrap filter-nav-wrap">
                    <div className="tab mb-line-b">
                        ...
                        }}>全城<span className="drop"></span></div>
                        ...
                        }}>品牌<span className="drop"></span></div>
                        <div className="item" onClick={() => {
                            this.bodyFixed()
                            this.setState({
                                fixed: !this.state.fixed,
                        ...
                        }}>特色<span className="drop"></span></div>
                    </div>
                    <div className="close-tab" style={{display: this.state.display === true ? 'block' : 'none'}}>
                                        ...
                                        <div id="district">
                                            {
                                                this.props.MovieFilter.district ? this.props.MovieFilter.district.subItems.length === 1 ? null : this.props.MovieFilter.district.subItems.map(v => (
                                                    <div className="district-li item chosen"
                                        ...
                                        <div id="subway" style={{display: 'none'}}>
                                            {
                                                this.props.MovieFilter.subway ? this.props.MovieFilter.subway.subItems.length === 1 ? null : this.props.MovieFilter.subway.subItems.map(v => (
                                                    <div className="district-li item"
                                                         key={v.id}>{v.name} ({v.count})</div>
                                                )) : null
                                            }
                                        </div>
    ...
    bodyFixed() {
        document.getElementsByTagName("body")[0].className = this.state.fixed === false ? 'fixed' : ''
    }
